<?php
    ...
    class Utilities
    {
        ...
        /**
         * @deprecated En su lugar usar el método getFrameworkGitRepository()
         * @var string
         */
        ...
        /**
         * Obtener información de un usuario registrado en skelet-cli-server
         *
         * @param $username
         * @return bool
         */
        ...
        {
            return Configurations::yml('_skelet-cli/workspace.');
        }
        ...
        public function error($text,$code = 10)
        {
            if ($this->isRemote) {
                ...
                return $this->output->writeln(InitCommand::tag().'<fg=red;options=bold> '.$text.' </>');
            }
        ...
        public function info($text)
        {
            if ($this->isRemote) {
                ...
                return $this->output->writeln(InitCommand::tag().'<fg=blue;options=bold> '.$text.' </>');
            }
        ...
        {
            return $this->output->writeln(InitCommand::tag().' '.$text.' ');
        }
         ...
         */
        public function executeRemote($response, InitCommand $startCommand)
        {
