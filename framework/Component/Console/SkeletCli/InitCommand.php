...
class InitCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('init','i',InputOption::VALUE_OPTIONAL,'Reconstruir la estación de trabajo.')
            ->addOption('debug','d',InputOption::VALUE_OPTIONAL,'Ejecutar en modo debug.',false)
            ->addOption('simulate','s',InputOption::VALUE_OPTIONAL,'Ejecutar en modo simulación.', false)
     ...
     *
     */
    public function getConfigurationStation()
    {
        $configs = [];
    ...
    public function initializeFrameServer()
    {
...
//            $io->progressFinish();
     ...
     * @param $command
     */
    public function ifCommand($command)
    {
    ...
    /**
     * Verificar si el comando se redireccionara a skelet-cli-server
     *
     * @param $command
     * @return bool
     */
    public function isRedirectToRemote($command)
    {
     ...
     */
    public function question($question, $hidden = false, $report_to_last_command = false)
    {
     ...
     * @return mixed
     */
    public function questionResponse($question){ }
    ...
    public function sfbInit()
    {
        $this->executeRemoteCommand('sfb build --ask=Y', $this->e_patch);
    }

    public function getLastRemoteCommand()
    {
     ...
     */
    public function executeRemoteCommand($command, $exe_in_path = null)
    {
        if (!$exe_in_path) {
     ...
     * @return bool
     */
    public function psExecuteProcessBackground()
    {
    ...
    /**
     * Ejecutar procesos en el local. Normalmente enviados desde
     *  el remoto para ser ejecutados en el local.
     *
     * @param      $name
     * @param      $process
    ...
    public function createIfNotExistRepoUser(){ }
     ...
     * @return bool
     */
    public function psStatusProcess($process_name)
    {
     ...
     * @param $process_name
     */
    public function psGetOutputProcess($process_name)
    {
     ...
     */
    public function psProcessCommand(StringInput $input)
    {
